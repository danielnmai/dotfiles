...
# IMPORTANT: Define zvm hooks BEFORE loading plugins
zvm_before_init() {
  ZVM_INSERT_MODE_CURSOR=$'\e[5 q\e]12;#00FFFF\a'
  ZVM_NORMAL_MODE_CURSOR=$'\e[1 q\e]12;#00FFFF\a'
}
...
# https://github.com/CareAccessResearch/care-console?tab=readme-ov-file
...
tunnel-server() {
  local -a ports=(-L 3000:localhost:3000 -L 8000:localhost:8000 -L 5432:localhost:5432)
